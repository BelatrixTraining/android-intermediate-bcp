...
public class NoteRepository {
    ...
    public void getAllNotes(PopulateCallback populateCallback){
        ...
        currentTask= new PopulateAsyncTask(noteDao, populateCallback);
        ((PopulateAsyncTask)(currentTask)).execute();
    }

    public void add(NoteEntity noteEntity){
        //noteDao.insert(noteEntity);
        currentTask=new InsertAsyncTask(noteDao);
        ((InsertAsyncTask)(currentTask)).execute(noteEntity);
    }
    ...
    public void addNotes(NoteEntity... noteList){
        ...
        currentTask= new InsertEntitiesAsyncTask(noteDao);
        ((InsertEntitiesAsyncTask)(currentTask)).execute(noteList);
    }
